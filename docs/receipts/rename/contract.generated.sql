...
-- Review: safety=review; hazards=rename_equality_assertion,table_scan; requires_gates=writers:legacy.
...
-- Review: safety=review; hazards=compatibility_removal,table_lock; requires_gates=writers:legacy.
DROP TRIGGER "onwardpg_sync_column_4cff936be08db67c" ON "app"."accounts";
-- Review: safety=review; hazards=compatibility_removal; requires_gates=writers:legacy.
DROP FUNCTION "app"."onwardpg_sync_column_4cff936be08db67c"();
-- Review: safety=dangerous; hazards=compatibility_removal,data_loss,access_exclusive_lock; requires_gates=writers:legacy.
ALTER TABLE "app"."accounts" DROP COLUMN "full_name";
-- Review: safety=review; hazards=compatibility_removal,access_exclusive_lock; requires_gates=writers:legacy.
