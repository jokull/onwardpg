...
-- onwardpg:edit begin stmt-sha256-a070058216c72140d80bb72a0de6eb047a025f76100708c1457a56097d7da73e
...
-- onwardpg:edit end stmt-sha256-a070058216c72140d80bb72a0de6eb047a025f76100708c1457a56097d7da73e
...
CREATE VIEW "app"."fact_view" AS SELECT facts.val
   FROM app.facts;
...
CREATE MATERIALIZED VIEW "app"."fact_cache" AS SELECT fact_view.val
